...
class Address(models.Model):
    ...
    country = CountryField(_('Country'), max_length=255)
    city = models.CharField(_('City'), max_length=120)
    address_line = models.TextField(_('Address'), blank=False,max_length=120)
    notes = models.TextField(_('Notes'), blank=True, max_length=255, default='', null=True)
